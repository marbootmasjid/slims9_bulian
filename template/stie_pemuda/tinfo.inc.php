...
<p>Perpustakaan STIE Pemuda Surabaya berkomitmen menyediakan akses sumber belajar dan referensi ilmiah terbaik bagi sivitas akademika.</p>
HTML;
$sysconf['template']['classic_library_disableslide'] = 0;


$sysconf['template']['option']['stie_pemuda'] = [
    'responsive' => [
        'dbfield' => 'responsive',
